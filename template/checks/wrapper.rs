...
pub fn run_all_checks() -> bool {
    ...
    {
        if antivm::anti_vm_comprehensive() {
            debugging_detected = true;
        }
    }
    ...
    {
        if antivm::anti_vm_timing_discrepancy() {
            debugging_detected = true;
        }
    }
